import { WrapperE } from "../Components/Wrappers/style";

const Privacy = () => {
    return(
        <>
            <WrapperE>
                <img src="../../assets/og-image.jpeg" alt="og-james" style={{height: 'auto', width: '40%'}}/>
                ...
                <p>All of your personal information collected will be used to help make your visit to our site as productive and enjoyable as possible.
                    <br/><br/>
                    The guarantee of the confidentiality of the personal data of the users of our site is important for Night Trick.
                    <br/><br/>
                    All personal information relating to members, subscribers, customers or visitors who use Night Trick will be treated in accordance with the Personal Data Protection Act of October 26, 1998 (Law No. 67/98).
                    <br/><br/>
                    ...
                    <br/><br/>
                    The use of Night Trick implies acceptance of this Privacy Agreement. The Night Trick team reserves the right to change this agreement without prior notice. Therefore, we recommend that you consult our privacy policy regularly so that you are always up to date.
                </p>
                <h1>Advertising</h1>
                ...
                <p>We use cookies to store information such as your personal preferences when you visit our website. This may include a simple popup, or a link to various services we provide, such as forums.
                    <br/><br/>
                ...
                <p>Night Trick has links to other sites, which, in our view, may contain useful information / tools for our visitors. Our privacy policy is not applied to third-party sites, so if you visit another site from ours, you should read its privacy policy.
                    <br/><br/>
                    We are not responsible for the privacy policy or content on these sites.
                </p>
            </WrapperE>
        </>
    )
